CREATE TYPE "public"."wallet_transaction_type" AS ENUM('recharge', 'withdrawal', 'order_payment', 'order_refund', 'sale_income');--> statement-breakpoint
...
CREATE TABLE "wallets" (
	...
	"balance_fcfa" integer DEFAULT 0 NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "wallets_user_id_unique" UNIQUE("user_id")
);
--> statement-breakpoint
ALTER TABLE "orders" ADD COLUMN "commission_fcfa" integer;--> statement-breakpoint
